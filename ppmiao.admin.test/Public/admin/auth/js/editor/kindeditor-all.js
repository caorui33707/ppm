		...
		var dialog = self.createDialog({
			...
			yesBtn : {
				...
				click : function(e) {
					...
					var url = [checkbox[0].checked ? self.pluginsPath + 'baidumap/member.html' : 'http://api.map.baidu.com/staticimage',
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function bindEvent(el, result, data, createFunc) {
			...
			if (data.is_dir) {
				...
				el.click(function(e) {
					clickFn.call(this, SITE + fileUrl, data.filename);
				});
			} else {
				el.click(function(e) {
		...
		function createView(result) {
			...
			for (var i = 0, len = fileList.length; i < len; i++) {
                ...
                if(data.is_photo) iconUrl = SITE + iconUrl;
