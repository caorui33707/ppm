        ...
        <div class="list" >
            <table id="checkList" class="list" cellpadding="0" cellspacing="0">
                ...
                <?php if(is_array($vip)): foreach($vip as $key=>$val): ?><tr>
                        ...
                        <td><?php echo ($val["vip"]["name"]); ?></td>
                        <td id="td_<?php echo ($val["id"]); ?>"><?php echo ($val["multiple"]); ?></td>
                        <td><a id="a_<?php echo ($val["id"]); ?>" href="javascript:void (0)" onclick="edit('<?php echo ($val["id"]); ?>')">编辑</a></td>
