...
<div id="main" class="main" >
    <div class="content">
        <div class="title">发放红包 <!--[ <a href="<?php echo C('ADMIN_ROOT');?>/Project/index">返回列表</a> ] --></div>
        ...
        <form id="frmMain" method='post' action="">
            ...
            <table cellpadding=3 cellspacing=3 >
                ...
                <tr>
                    <td class="tRight">红包金额：</td>
                    <td class="tLeft"><input type="text" class="bLeftRequire" datatype="n" id="amount" name="amount" value="" />&nbsp;<span style="color:#409DFE;">单位：元</span></td>
                </tr>
				...
				<tr>
                    ...
                    <td class="tLeft">
                    	<input type="text" class="laydate-icon" name="create_time" id="create_time" readonly />
...
<!-- <script type="application/javascript" src="/Public/admin/js/project_add.js?v=1.4"></script> -->