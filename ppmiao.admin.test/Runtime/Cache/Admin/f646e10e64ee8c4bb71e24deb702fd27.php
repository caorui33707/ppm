...
<div id="main" class="main" >
    <div class="content">
        <div class="title">广告管理 - 产品公告管理 [ <a href="<?php echo C('ADMIN_ROOT');?>/Advertisement/project_notic_tag_index/p/<?php echo ((isset($params["page"]) && ($params["page"] !== ""))?($params["page"]):1); ?>">返回列表</a> ]</div>
        ...
        <form id="frmMain" method='post' action="">
            ...
            <table cellpadding=3 cellspacing=3 >
                <tr>
                    ...
                    <td class="tLeft">
                        <input type="text" class="" name="tag_title" value="<?php echo ($detail["tag_title"]); ?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="tLeft">
                        <input type="text" class="laydate-icon" name="start_time" id="start_time" value="<?php echo (date('Y-m-d H:i:s',$detail["start_time"])); ?>" />
                        <input type="text" class="laydate-icon" name="end_time" id="end_time" value="<?php echo (date('Y-m-d H:i:s',$detail["end_time"])); ?>" />
                    </td>
                </tr>

                <tr>
                    <td class="tRight">备注：</td>
                    <td class="tLeft"><textarea id="description" name="description" class="huge" maxlength="255" style="height:80px;"><?php echo ($detail["description"]); ?></textarea></td>
                </tr>
