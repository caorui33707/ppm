...
<div class="message">
    <table class="message"  cellpadding=0 cellspacing=0 >
        <tr>
            <td height='3'  class="topTd" ></td>
        </tr>
        <tr class="row" >
            <th class="tCenter space"><?php echo ($msgTitle); ?></th>
        </tr>
        <?php if(isset($message)): ?><tr class="row">
            <td style="color:blue"><img src="/Public/admin/auth/images/admin_icon_success.png" />&nbsp;<?php echo ($message); ?></td>
        </tr><?php endif; ?>
        <?php if(isset($error)): ?><tr class="row">
            <td style="color:red"><img src="/Public/admin/auth/images/admin_icon_error.png" />&nbsp;<?php echo ($error); ?></td>
        </tr><?php endif; ?>
        ...
        <?php if(!isset($closeWin)): ?><tr class="row">
            <td>系统将在 <span id="wait" style="color:blue;font-weight:bold"><?php echo ($waitSecond); ?></span> 秒后自动跳转,如果不想等待,直接点击 <a id="href" href="<?php echo ($jumpUrl); ?>">这里</a> 跳转</td>
        </tr><?php endif; ?>
        <tr>
            <td height='3' class="bottomTd"></td>
        </tr>
	</table>
</div>
