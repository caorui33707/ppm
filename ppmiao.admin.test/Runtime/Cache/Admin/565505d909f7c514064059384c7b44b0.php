...
<div id="main" class="main" >
    <div class="content">
        <div class="title">广告管理 - 添加广告 [ <a href="<?php echo C('ADMIN_ROOT');?>/Advertisement/index">返回列表</a> ]</div>
                ...
                <tr>
                    ...
                    <td class="tLeft" >
                        <select name="position" id="position">
                            <?php if(is_array($position)): foreach($position as $key=>$item): ?><option value="<?php echo ($key); ?>"><?php echo ($item); ?></option><?php endforeach; endif; ?>
                        </select>
                    </td>
                </tr>
                <tr>
