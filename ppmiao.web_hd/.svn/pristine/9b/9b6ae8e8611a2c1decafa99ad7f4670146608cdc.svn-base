...
{   
    ...
    private $jump_Android = 'https://image.ppmiao.com/download/app-tuijianhaoyou-release-96-2.5.0.apk';
    ...
    */
    ...
    public function invite2()
    {
        ...
        $this->display('Activity/invite/new_login_2');
    }
    ...
    public function tgllb(){
        ...
        // 问卷星 注册页面
        if($ch == 'wenjuanxing'){
            $this->display('Activity/wenjuanxing/res');
        } else {
            $type = $this->transType($ch);
            $this->assign('chinese_characters',$type);
            //新的渠道8888
    ...
    *   问卷星渠道
     */
    public function wenjuanxing_res(){
        ...
        if($ret == 'N2') {
            ...
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/wenjuanxing_res_succ.html?ch='.$ch));
        } else if($ret == 'Y0') { //成功
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/wenjuanxing_res_succ.html?ch='.$ch));
        } else {
            $this->ajaxReturn(array('status'=>0,'info'=>'注册失败，请联系客服人员！错误码：'.$ret));
    ...
    */
    ...
    /*
      问卷星 成功页面
     */
    public function wenjuanxing_res_succ(){
        $type = I('type');
        $ch = 'wenjuanxing';
        $is_weixin = 0;
        if(is_weixin()){
        ...
        $this->assign('is_weixin',$is_weixin);
        $this->assign('device_type',get_device_type());
        $this->display('Activity/wenjuanxing/res_succ');
    }
    ...
    */
    private function _jump_url($ch) {
        ...
        if(get_device_type()=='ios') {
            ...
            $url = $this->_jump_url_arr($ch);
            /*switch ($ch) {
                case 'llb':
                    $url = 'https://image.ppmiao.com/download/app-llb-release-96-2.5.0.apk';
                    break;
                case 'diantai':
                    $url = 'https://image.ppmiao.com/download/app-diantai-release-96-2.5.0.apk';
                    break;
                case 'InMoBi':
                    $url = 'https://image.ppmiao.com/download/app-inmobi-release-96-2.5.0.apk';
                    break;
                case 'danlan':
                    $url = 'https://image.ppmiao.com/download/app-danlan-release-96-2.5.0.apk';
                    break;
                case 'jrtt':
                    $url = 'https://image.ppmiao.com/download/app-jrtt-release-96-2.5.0.apk';
                    break;
                case 'jrtt2':
                    $url = 'https://image.ppmiao.com/download/app-jrtt2-release-96-2.5.0.apk';
                    break;
                case 'fcjn':
                    $url = 'https://image.ppmiao.com/download/app-fcjn-release-96-2.5.0.apk';
                    break;
                case 'dianxin':
                    $url = 'https://image.ppmiao.com/download/app-dianxin-release-96-2.5.0.apk';
                    break;
                case 'shenma':
                    $url = 'https://image.ppmiao.com/download/app-shenma-release-96-2.5.0.apk';
                    break;
                case 'xihuzhisheng':
                    $url = 'https://image.ppmiao.com/download/app-xihuzhisheng-release-96-2.5.0.apk';
                    break;
                case 'huisuoping':
                    $url = 'https://image.ppmiao.com/download/app-huisuoping-release-96-2.5.0.apk';
                    break;
                case 'chubao':
                    $url = 'https://image.ppmiao.com/download/app-chubao-release-96-2.5.0.apk';
                    break;
                case 'PPTV':
                    $url = 'https://image.ppmiao.com/download/app-PPTV-release-96-2.5.0.apk';
                    break;
                case '_907':
                    $url = 'https://image.ppmiao.com/download/app-_907-release-96-2.5.0.apk';
                    break;
                case 'wenjuanxing':
                    $url = 'https://image.ppmiao.com/download/app-wenjuanxing-release-96-2.5.0.apk';
                    break;
                case 'qutoutiao':
                    $url = 'https://image.ppmiao.com/download/app-qutoutiao-release-96-2.5.0.apk';
                    break;
                case 'zhonghua':
                    $url = 'https://image.ppmiao.com/download/app-zhonghua-release-96-2.5.0.apk';
                    break;
                case 'qixi':
                    $url = 'https://image.ppmiao.com/download/app-qixi-release-96-2.5.0.apk';
                    break;
                case '_918zs':
                    $url = 'https://image.ppmiao.com/download/app-_918zs-release-96-2.5.0.apk';
                    break;
                case 'tengxun':
                    $url = 'https://image.ppmiao.com/download/app-tengxun-release-96-2.5.0.apk';
                    break;
                case 'jumeitoutiao':
                    $url = 'https://image.ppmiao.com/download/app-jumeitoutiao-release-96-2.5.0.apk';
                    break;
                case 'qq1':
                    $url = 'https://image.ppmiao.com/download/app-qq1-release-96-2.5.0.apk';
                    break;
                case 'qq2':
                    $url = 'https://image.ppmiao.com/download/app-qq2-release-96-2.5.0.apk';
                    break;
                case 'qq3':
                    $url = 'https://image.ppmiao.com/download/app-qq3-release-96-2.5.0.apk';
                    break;
                case 'qq4':
                    $url = 'https://image.ppmiao.com/download/app-qq4-release-96-2.5.0.apk';
                    break;
                case 'qq5':
                    $url = 'https://image.ppmiao.com/download/app-qq5-release-96-2.5.0.apk';
                    break;
                case 'aiqiyi':
                    $url = 'https://image.ppmiao.com/download/app-aiqiyi-release-96-2.5.0.apk';
                    break;
                case 'wydz':
                    $url = 'https://image.ppmiao.com/download/app-wydz-release-96-2.5.0.apk';
                    break;
                case 'dailuopan':
                    $url = 'https://image.ppmiao.com/download/app-dailuopan-release-96-2.5.0.apk';
                    break;
                case 'xjzdy':
                    $url = 'https://image.ppmiao.com/download/app-xjzdy-release-96-2.5.0.apk';
                    break;
                case 'quanzi':
                    $url = 'https://image.ppmiao.com/download/app-quanzi-release-96-2.5.0.apk';
                    break;
                case 'mmsc':
                    $url = 'https://image.ppmiao.com/download/app-mmsc-release-96-2.5.0.apk';
                    break;
                case 'bbs':
                    $url = 'https://image.ppmiao.com/download/app-bbs-release-96-2.5.0.apk';
                    break;
                case 'qlgdt':
                    $url = 'https://image.ppmiao.com/download/app-qlgdt-release-96-2.5.0.apk';
                    break;
                case 'qltt':
                    $url = 'https://image.ppmiao.com/download/app-qltt-release-96-2.5.0.apk';
                    break;
                case 'byong1':
                    $url = 'https://image.ppmiao.com/download/app-byong1-release-96-2.5.0.apk';
                    break;
                case 'byong2':
                    $url = 'https://image.ppmiao.com/download/app-byong2-release-96-2.5.0.apk';
                    break;
                case 'byong3':
                    $url = 'https://image.ppmiao.com/download/app-byong3-release-96-2.5.0.apk';
                    break;
                case 'byong4':
                    $url = 'https://image.ppmiao.com/download/app-byong4-release-96-2.5.0.apk';
                    break;
                case 'byong5':
                    $url = 'https://image.ppmiao.com/download/app-byong5-release-96-2.5.0.apk';
                    break;
                case 'ws1':
                    $url = 'https://image.ppmiao.com/download/app-ws1-release-96-2.5.0.apk';
                    break;
                case 'ws2':
                    $url = 'https://image.ppmiao.com/download/app-ws2-release-96-2.5.0.apk';
                    break;
                case 'ws3':
                    $url = 'https://image.ppmiao.com/download/app-ws3-release-96-2.5.0.apk';
                    break;
                case 'ws4':
                    $url = 'https://image.ppmiao.com/download/app-ws4-release-96-2.5.0.apk';
                    break;
                case 'ws5':
                    $url = 'https://image.ppmiao.com/download/app-ws5-release-96-2.5.0.apk';
                    break;
                case 'wifiktt':
                    $url = 'https://image.ppmiao.com/download/app-wifiktt-release-96-2.5.0.apk';
                    break;
                case 'gjc':
                    $url = 'https://image.ppmiao.com/download/app-gjc-release-96-2.5.0.apk';
                    break;
                case 'ttcf':
                    $url = 'https://image.ppmiao.com/download/app-ttcf-release-96-2.5.0.apk';
                    break;
                case 'dshb':
                    $url = 'https://image.ppmiao.com/download/app-dshb-release-96-2.5.0.apk';
                    break;
                case 'yjwh':
                    $url = 'https://image.ppmiao.com/download/app-yjwh-release-96-2.5.0.apk';
                    break;
                case 'lqw': // 利趣网
                    $url = 'https://image.ppmiao.com/download/app-lqw-release-96-2.5.0.apk';
                    break;
                case 'hnw': //
                    $url = 'https://image.ppmiao.com/download/app-hnw-release-96-2.5.0.apk';
                    break;
                //default:
                    //$url = 'https://image.ppmiao.com/download/app-llb-release-96-2.5.0.apk';
            }*/
    ...
    public function lqw_login(){
        $this->assign('ch','lqw');
        $this->display('Activity/lqw/lqw_login');
    }

    /*
     * 利趣网 注册判断
     */
    public function lqw_res(){
        $code = I('post.code','','strip_tags');
        $mobile = I('post.mobile','','strip_tags');
        //渠道
        $ch = I('post.ch','','strip_tags');
        ...
        if($ret == 'N2') {
            ...
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/lqw_succ.html?type=1'));// &ch='.$ch
        } else if($ret == 'Y0') { //成功
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/lqw_succ.html?type=2')); // ch='.$ch
        } else {
            $this->ajaxReturn(array('status'=>0,'info'=>'注册失败，请联系客服人员！错误码：'.$ret));
        }
    }
    ...
    public function lqw_succ(){
        ...
        $this->display('Activity/lqw/lqw_succ');
    }

    /*
     * 海鸟窝  注册
     */
    public function hnw_login(){
        $this->assign('ch','hnw');
        $this->display('Activity/hnw/hnw_login');
    }

    /*
    * 海鸟窝 注册判断
    */
    public function hnw_res(){
        $code = I('post.code','','strip_tags');
        $mobile = I('post.mobile','','strip_tags');
        //渠道
        $ch = I('post.ch','','strip_tags');
        ...
        if($ret == 'N2') {
            ...
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/hnw_succ.html?type=1'));// &ch='.$ch
        } else if($ret == 'Y0') { //成功
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/hnw_succ.html?type=2')); // ch='.$ch
        } else {
            $this->ajaxReturn(array('status'=>0,'info'=>'注册失败，请联系客服人员！错误码：'.$ret));
        }
    }
    ...
    public function hnw_succ(){
        ...
        $this->display('Activity/hnw/hnw_succ');
    }
    ...
    * 资产存管  注册
    */
    public function llyh_login(){
        $this->assign('ch','llyh');
        $this->display('Activity/llyh/llyh_login');
    }

    /*
    * 资产存管 注册判断
    */
    public function llyh_res(){
        $code = I('post.code','','strip_tags');
        $mobile = I('post.mobile','','strip_tags');
        //渠道
        $ch = I('post.ch','','strip_tags');
        ...
        if($ret == 'N2') {
            ...
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/llyh_succ.html?type=1'));// &ch='.$ch
        } else if($ret == 'Y0') { //成功
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/llyh_succ.html?type=2')); // ch='.$ch
        } else {
            $this->ajaxReturn(array('status'=>0,'info'=>'注册失败，请联系客服人员！错误码：'.$ret));
        }
    }
    ...
    public function llyh_succ(){
        ...
        $this->display('Activity/llyh/llyh_succ');
    }

    /*
    *   财经新闻 注册
    */
    public function cjxw_login(){
        $ch = 'cjxw';
        $this->assign('ch',$ch);
        //埋点统计
        $typeCharacters = $this->transType($ch);
        $this->assign('chinese_characters',$typeCharacters);

        $this->display('Activity/cjxw/cjxw_login');
    }

    /*
    *  财经新闻 注册判断
    */
    public function cjxw_res(){
        $code = I('post.code','','strip_tags');
        $mobile = I('post.mobile','','strip_tags');
        //渠道
        $ch = I('post.ch','','strip_tags');
        ...
        if($ret == 'N2') {
            ...
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/cjxw_succ.html?type=1'));// &ch='.$ch
        } else if($ret == 'Y0') { //成功
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/cjxw_succ.html?type=2')); // ch='.$ch
        } else {
            $this->ajaxReturn(array('status'=>0,'info'=>'注册失败，请联系客服人员！错误码：'.$ret));
        }
    }
    ...
    public function cjxw_succ(){
        ...
        $this->assign('device_type',get_device_type());
        if($type == 2) {
            $this->display('Activity/cjxw/cjxw_reg');
        }else{
            $this->display('Activity/cjxw/cjxw_succ');
        }
    }
    ...
    *  金融头条 注册
    */
    public function jinrongtt_login(){
        $ch = 'jinrongtt';
        $this->assign('ch',$ch);
        ...
        $this->display('Activity/jinrongtt/jinrongtt_login');
    }

    /*
    *  金融头条 注册判断
    */
    public function jinrongtt_res(){
        $code = I('post.code','','strip_tags');
        $mobile = I('post.mobile','','strip_tags');
        //渠道
        $ch = I('post.ch','','strip_tags');
        ...
        if($ret == 'N2') {
            ...
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/jinrongtt_succ.html?type=1'));// &ch='.$ch
        } else if($ret == 'Y0') { //成功
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/jinrongtt_succ.html?type=2')); // ch='.$ch
        } else {
            $this->ajaxReturn(array('status'=>0,'info'=>'注册失败，请联系客服人员！错误码：'.$ret));
        }
    }
     ...
     * 金融头条 注册成功
     */
    public function jinrongtt_succ(){
        $type = I('type');
        $ch = 'jinrongtt';
        $is_weixin = 0;
        if(is_weixin()){
        ...
        $this->assign('device_type',get_device_type());
        if($type == 2){
            $this->display('Activity/jinrongtt/jinrongtt_reg');
        }else {
            $this->display('Activity/jinrongtt/jinrongtt_succ');
        }
    }
    ...
    * 问卷星2  注册
    */
    public function wenjuanxing2_login(){
        $this->assign('ch','wenjuanxing2');
        $this->display('Activity/wenjuanxing/wenjuanxing2_login');
    }

    /*
    * 问卷星2 注册判断
    */
    public function wenjuanxing2_res(){
        $code = I('post.code','','strip_tags');
        $mobile = I('post.mobile','','strip_tags');
        //渠道
        $ch = I('post.ch','','strip_tags');
        ...
        if($ret == 'N2') {
            ...
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/wenjuanxing2_succ.html?type=1'));// &ch='.$ch
        } else if($ret == 'Y0') { //成功
            $this->ajaxReturn(array('status'=>1,'info'=>'/hd/wenjuanxing2_succ.html?type=2')); // ch='.$ch
        } else {
            $this->ajaxReturn(array('status'=>0,'info'=>'注册失败，请联系客服人员！错误码：'.$ret));
        }
    }
     ...
     * 问卷星2 注册成功
     */
    public function wenjuanxing2_succ(){
        $type = I('type');
        $ch = 'wenjuanxing2';
        $is_weixin = 0;
        if(is_weixin()){
        ...
        $this->display('Activity/wenjuanxing/wenjuanxing2_succ');
    }
