...
;(function($){
	...
	$.movingBoxes = function(el, options){
		...
		base.init = function(){
			...
			base.$left = $('.MCIndexBox03Inner02Left').click(function(){
				base.goBack();
				return false;
			});
			base.$right =$('.MCIndexBox03Inner02Right').click(function(){
				base.goForward();
				return false;
			});
		...
		base.setSizes = function(flag){
			...
			base.heights = base.$panels.css('height','').map(function(i,e){ return $(e).outerHeight(true); }).get();
