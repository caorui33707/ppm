...
<script type="text/javascript">
    $(document).ready(function(){
     ...
     <div class="bannerInner bannerInner02">
    	<ul>
            <li style="background:url(<?php echo C('STATIC_ROOT');?>/ppmiao/images/MCPrivacyBanner.png) no-repeat scroll center top; display:block"><a href="#"></a></li>
        </ul>
    </div>
    ...
    <div class="MCPrivacyBox01Bg">
    	<div class="MCPrivacyBox01TitleBg fLe clear">
        	<i class="arrow03"></i>
        	<div class="MCPrivacyBox01Title w1003 clear"><h5>隐私保护</h5></div>
        </div>
