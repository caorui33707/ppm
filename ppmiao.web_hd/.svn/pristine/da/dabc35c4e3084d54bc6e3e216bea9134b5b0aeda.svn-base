...
(function($) {
    $.snowfall = function(element, options) {
        ...
        function Flake(_x, _y, _size, _speed, _id) {
            ...
            if (options.image) {
                var img = ["",static_url+"images/4@2x.png",static_url+"images/1@2x.png",static_url+"images/3@2x.png",static_url+"images/3@2x_66.png",static_url+"images/5@2x.png",static_url+"images/6@2x.png",static_url+"images/9@2x.png",static_url+"images/10@2x.png"];
                flakeMarkup = $(document.createElement("img"));
                flakeMarkup[0].src = img[Math.ceil(Math.random() * 8)];
                //console.log(Math.ceil(Math.random() * 8));
                //console.log(flakeMarkup[0].src);
            } else {
